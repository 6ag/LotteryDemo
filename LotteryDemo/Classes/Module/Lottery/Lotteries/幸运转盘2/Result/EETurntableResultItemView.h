...
@interface EETurntableResultItemView : UIView
...
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *width_imageView;
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *width_bgView;
