...
@interface EETurntableAnimView () <CAAnimationDelegate>
...
@implementation EETurntableAnimView
...
- (void)setupTurntableGiftView
{
    ...
    for (int i = 0; i < self.giftArray.count; i++) {
        ...
        giftPriceLabel.font = [UIFont boldSystemFontOfSize:12];
        giftPriceLabel.textColor = UIColorHex(#FFFFFF);
