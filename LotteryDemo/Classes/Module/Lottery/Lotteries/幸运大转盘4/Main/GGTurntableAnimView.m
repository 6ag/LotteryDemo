...
@interface GGTurntableAnimView () <CAAnimationDelegate>
...
@implementation GGTurntableAnimView
...
{
    self.top_turntableImageView.constant = JFWidthRadio(23);
    self.bottom_turntableImageView.constant = JFWidthRadio(23);
    self.left_turntableImageView.constant = JFWidthRadio(23);
    self.right_turntableImageView.constant = JFWidthRadio(23);
}
...
- (void)setupTurntableGiftView
{
    ...
    for (int i = 0; i < self.giftArray.count; i++) {
        ...
        CGFloat offsetRadian = radian - perRadian * 3;
        ...
        giftNameLabel.font = JFFontPingFangSCMedium(12);
        giftNameLabel.textColor = UIColorHex(#861414);
